...
;array DW 0ABCDh, 0BCDFh, 0BCDAh, 012A3h, 0574Fh, 01357h, 08888h, 01337h, 04488h, 0228Ch, 0DEF1h, 00h
...
LOOOP_START_ODD:
    ...
    LOOP_SORT_ODD:
        ...
        JL NO_SWAP_ODD          ; если значение меньше или равно, то пропускаем перестановку
...
LOOOP_START_EVEN:
    ...
    LOOP_SORT_EVEN:
        MOV AX, [BP+SI]         ; занечти в AX элемент массива  
        CMP AX, [BP+SI+2]       ; сравнить значение в AX со следующим элементом массива
        JG NO_SWAP_EVEN         ; если значение больше или равно, то пропускаем перестановку
        XCHG AX, [BP+SI+2]      ; меняем местами два операнда
        MOV [BP+SI], AX         ; заносим значение
        MOV DX, 1               ; ставим значение 1, тоесть перестановка было
        NO_SWAP_EVEN:
